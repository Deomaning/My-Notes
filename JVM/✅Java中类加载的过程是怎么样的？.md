...
![1706422325589-7a4b6e5c-360f-4137-82c8-f43eacda5c4f.png](./img/G65NZbqgdFu3Epub/1706422325589-7a4b6e5c-360f-4137-82c8-f43eacda5c4f-298328.png)
...
3. **解析**：把类的符号引用转为直接引用\_(类或接口、字段、类方法、接口方法、方法类型、方法句柄和访问控制修饰符7类符号引用 )\_
...
5. 当使用 JDK1.7 的动态语言时，如果一个 MethodHandle 实例的最后解析结构为 REF\_getStatic、REF\_putStatic、REF\_invokeStatic、的方法句柄，并且这个句柄没有初始化，则需要先触发器初始化
...
> 更新: 2024-08-13 21:00:30  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/tuikxhaa2urq32ds>