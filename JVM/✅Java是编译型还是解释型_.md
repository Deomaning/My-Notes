...
![1667472378969-dfd5e776-aab6-4a30-94af-6067fbfdc71d.jpeg](./img/zrPG2nse7igVwwM4/1667472378969-dfd5e776-aab6-4a30-94af-6067fbfdc71d-300941.jpeg)
...
**我们可以把将**<code>**.java**</code>**文件编译成**<code>**.class**</code>**的编译过程称之为前端编译。把将**<code>**.class**</code>**文件翻译成机器指令的编译过程称之为后端编译。**
...
看，这个代码你肯定看的懂，因为这不就是标准的java的源代码么。这个就很清楚的可以看到原来**字符串的switch是通过**<code>**equals()**</code>**和**<code>**hashCode()**</code>**方法来实现的**。
...
> 更新: 2024-03-10 13:43:28  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/ylde5u>