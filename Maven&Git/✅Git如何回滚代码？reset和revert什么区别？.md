...
首先，说**本地文件修改**，如果你只是想撤销本地文件的修改并恢复到上一次提交时的状态，可以使用<code>**git checkout**</code>命令。例如，如果你想撤销对文件example.txt的修改，可以运行以下命令：`git checkout example.txt`。

如果你的代码本地修改后，使用了git\*\* commit或者push提交到了分支上\*\*，想要撤销这一次的提交的话，那么可以使用<code>**git revert**</code>和<code>**git reset**</code>命令。
...
> 更新: 2023-12-04 22:47:18  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/oh1ocn2wd0ocxz00>