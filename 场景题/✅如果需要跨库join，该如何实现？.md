...
[✅为什么大厂不建议使用多表join？](https://www.yuque.com/hollis666/vhr2ge/qt4krg#R2JoQ)
...
所以我们可以把数据同步到一个第三方的数据库中，这个库可以是mysql，也可以是一些数据分析相关的数据库，比如AnalyticDB这种数据库。
...
> 更新: 2025-12-28 15:43:21  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/br8q53x9u4rb8t12>