...
[✅分表算法都有哪些？](https://www.yuque.com/hollis666/vhr2ge/anpg4kfcb8p7egag)
...
行表达式分片策略用的多的原因是因为他比较简单，不需要单独做算法的实现，只需要写 groovy 表达式进行分片即可，如: `t_user_$->{u_id % 8}` 表示t\_user表根据u\_id模8，而分成8张表，表名称为t\_user\_0到t\_user\_7。
...
> 更新: 2024-05-25 17:15:55  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/lqateep6fkcxtz5z>