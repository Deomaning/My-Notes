...
但是，在Spring 6.0 发布之后，Spring内置了一个HTTP客户端——@HttpExchange （<https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/web/service/annotation/HttpExchange.html> ），建议大家使用这个客户端进行HTTP调用。
...
以上，服务在启动后，通过`http://localhost:8080/users`地址访问后会得到多个我生成的用户信息。
...
> 更新: 2025-11-09 18:40:21  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/itmcpq5517975ttq>