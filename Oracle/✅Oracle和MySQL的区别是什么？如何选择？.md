...
| **分页** | ROWNUM 或者 ROW\_NUMBER() | <font style="color:rgb(37, 41, 51);"> limit</font> |
| **索引** | B+ 树、位图、反向键、函数索引、域索引 | B+树、全文、哈希索引 |
| **数据恢复** | <font style="color:rgb(51, 51, 51);">RAC</font> | <font style="color:rgb(51, 51, 51);">主从复制</font> |
| **字符串连接** | <code><font style="color:rgb(51, 51, 51);">||</font></code><font style="color:rgb(51, 51, 51);">运算符</font> | CONCAT函数 |
| **其他** | <font style="color:rgb(51, 51, 51);">...</font> | ... |


> 更新: 2024-06-15 18:45:04  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/hrdea48tzqmtizbk>