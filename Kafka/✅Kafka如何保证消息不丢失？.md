...
那么，为了保证消息不丢失，通常会建议**使用**<code>**producer.send(msg, callback)**</code>**方法**，这个方法支持传入一个callback，我们可以在消息发送时进行重试。
...
> 更新: 2023-12-04 22:46:14  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/imx4a7z8zq65erlo>