...
`WHERE`子句用于对结果集进行过滤，无论是简单的SELECT查询还是复杂的JOIN查询。<code>**WHERE**</code>**子句在JOIN操作之后应用，即在所有的JOIN操作完成后，对这个已经组合起来的数据集进行过滤。**
...
> 更新: 2024-01-20 15:53:10  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/iiasw1frpq30mdvo>