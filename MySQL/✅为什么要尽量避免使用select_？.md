...
[✅为什么MySQL 8.0要取消查询缓存？](https://www.yuque.com/hollis666/vhr2ge/wuzidroy4wl3xag9)

还有一个就是可能会导致隐患，比如我们之前就出现过，线上增加了一个新的字段，但是这个字段只在数据库中加了，代码中还不能用，这时候select \*就会查到这个字段，就会导致处理异常。当然，这个原因并没那么重要，主要还是上面两个问题。


> 更新: 2025-04-04 13:01:49  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/wgmpg7gsqhbc9vmi>