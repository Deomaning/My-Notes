...
[✅一个查询语句的执行顺序是怎么样的？](https://www.yuque.com/hollis666/vhr2ge/ihsu18bwvr9csnzu)
...
2. **将数据按照 **<code>**ORDER BY**</code>** 排序**。
3. **根据 **<code>**LIMIT**</code>** 参数选择返回的记录**：
...
* `LIMIT row_count`如果和`ORDER BY`结合使使用，则在找到前row\_count就停止。
...
> 更新: 2025-03-15 15:54:25  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/zfvodtm4bk19eyvb>