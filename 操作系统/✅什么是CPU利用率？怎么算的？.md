...
>
> guest\_nice 从系统启动到现在，CPU运行在通过Linux内核控制的客户操作系统上的虚拟cpu的时间, nice 为负值进程
...
<code>**CPU利用率**</code>**是对一个时间段内CPU使用状况的统计，通过这个指标可以看出在某一个时间段内CPU被占用的情况。**

<code>**CPU的Load**</code>**是在一段时间内CPU正在处理以及等待CPU处理的进程数之和的统计信息，也就是CPU使用队列的长度的统计信息。**
...
> 更新: 2024-01-28 15:17:32  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/hhmxp4xri441moiq>