...
如果你看过《[单例模式的多种写法](https://www.yuque.com/hollis666/vhr2ge/ggh2h0)》中的实现单例的所有方式的代码，那就会发现，各种方式实现单例的代码都比较复杂。主要原因是在考虑线程安全问题。
...
[✅如何破坏单例模式？](https://www.yuque.com/hollis666/vhr2ge/vqtp00#WKH7c)

但是，枚举的反序列化并不是通过Unsafe，也不是通过反射实现的。所以，也就不会发生由于反序列化导致的单例破坏问题。


> 更新: 2024-02-29 22:32:15  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/dt4dp5iq77akg00u>