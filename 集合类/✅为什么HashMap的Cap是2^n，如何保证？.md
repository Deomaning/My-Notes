...
[✅HashMap的hash方法是如何实现的？](https://www.yuque.com/hollis666/vhr2ge/sz24zwwrdg92qizg)
...
![1668839424702-a03b79f5-bcf1-45c3-9151-9308d8d0ead1.jpeg](./img/--ZaZ7FF-SWYcMHZ/1668839424702-a03b79f5-bcf1-45c3-9151-9308d8d0ead1-080159.jpeg)
...
**但是还有一种特殊情况套用以上公式不行，这些数字就是2的幂自身。如果cap=4套用公式的话。得到的会是 8，不过其实这个问题也被解决了，重点就在**<code>**int n = cap - 1;**</code>**这行代码中，HashMap会事先将用户给定的容量-1，这样就不会出现上述问题了**
...
[🔜为什么HashMap的默认负载因子设置成0.75](https://www.yuque.com/hollis666/vhr2ge/qq99gipzlvhzcuer)
...
> 更新: 2025-08-02 12:59:09  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/ud3e99>