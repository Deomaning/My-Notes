...
![1669638424320-b15cfa40-ffc2-4ca0-9b61-78fccdf450cc.png](./img/IuRiUbtdpHLCJ2_b/1669638424320-b15cfa40-ffc2-4ca0-9b61-78fccdf450cc-291442.png)
...
<font style="color:rgb(15, 17, 21);">与 UUIDv1 使用相同的信息（时间、MAC地址），但重新排列了字节顺序，解决了 UUIDv1 的排序不友好问题。</font>

**<font style="color:rgb(15, 17, 21);">V7.基于时间戳+随机数的UUID（</font>****<u><font style="color:rgb(15, 17, 21);">新一代 UUID</font></u>****<font style="color:rgb(15, 17, 21);">）</font>**

<font style="color:rgb(15, 17, 21);">使用当前时间戳（毫秒精度）作为高位，剩余部分用随机数填充。</font>

<font style="color:rgb(15, 17, 21);"></font>

<font style="color:rgb(15, 17, 21);">一个 UUIDv7 是一个 128 位的数字（32 个十六进制字符，以 </font><code><font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">xxxxxxxx-xxxx-Mxxx-Nxxx-xxxxxxxxxxxx</font></code><font style="color:rgb(15, 17, 21);"> 的形式显示）。它的结构经过精确定义，以嵌入一个时间戳。</font>
...
**<font style="color:rgb(15, 17, 21);">UUIDv7 一定能保证有序吗？</font>**

* **<font style="color:rgb(15, 17, 21);">在宏观时间尺度上（跨毫秒），答案是肯定的。</font>**
* **<font style="color:rgb(15, 17, 21);">在微观时间尺度上（同一毫秒内），答案取决于实现方式，但几乎所有主流实现都确保了其可排序性。</font>**<font style="color:rgb(15, 17, 21);"> 使用计数器实现的库提供了绝对的顺序保证。</font>

JDK官网目前还未支持UUID v7，想要用的话，需要自己实现或者引入第三方的包，如：<https://github.com/cowtowncoder/java-uuid-generator>
...
> 更新: 2025-11-15 13:09:26  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/pi2zfc9ykug141im>