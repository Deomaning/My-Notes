...
[✅String、StringBuilder和StringBuffer的区别？](https://www.yuque.com/hollis666/vhr2ge/pg23qhb7rgnuamd1#rBBk1)
...
<font style="color:rgb(13, 13, 13);">也就说，利用</font><code><font style="color:rgb(13, 13, 13);">invokedynamic</font></code><font style="color:rgb(13, 13, 13);">的特性，</font>将字符串拼接的操作**延迟到运行时**，而不是在编译时固定使用`StringBuilder`<font style="color:rgb(13, 13, 13);">。（前面的链接中我们做过反编译，可见+转成 StringBuilder是编译的时候就确定了的。）</font>
...
> 更新: 2024-07-13 16:35:40  
> 原文: <https://www.yuque.com/hollis666/vhr2ge/ifyf24hsuuvwynlp>